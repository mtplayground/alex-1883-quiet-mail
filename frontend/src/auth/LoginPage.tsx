...
export function LoginPage({ error, onLogin }: LoginPageProps) {
  return (
    <main className="grid min-h-screen place-items-center px-6 py-12 text-ink">
      <section className="w-full max-w-sm rounded-ui border border-line bg-panel/90 px-7 py-8 shadow-[0_18px_50px_rgb(var(--shadow-subtle)_/_0.14)] backdrop-blur-md">
